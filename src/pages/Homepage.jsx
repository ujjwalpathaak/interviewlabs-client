...
function Homepage() {
  ...
  return (
    <div className="h-[100vh] w-full bg-[#EEEEEE] flex justify-center font-sans">
      ...
      <div className="h-100vh sm:max-h-[1080px] max-w-screen-xl">
        <div className=" h-[20vh] w-full flex flex-col sm:items-center justify-between p-4 sm:flex-row sm:h-[10%]">
          <img className="z-[2] h-14 sm:h-8" src={logo} alt="logo" />
        ...
        <div className="flex flex-col h-[80vh] justify-around sm:flex-row sm:h-[90%]">
          <div className="h-fit w-[100%] flex flex-col justify-left items-start pl-4 sm:w-[40%] sm:h-[100%] sm:items-center sm:justify-center sm:pl-0">
            <div className="flex-col h-fit w-[60%] justify-center items-center sm:h-[50%] sm:tracking-tighter ">
              <span className="m-0 block text-[#393E46] font-extrabold text-5xl z-[2]  sm:text-[350%] sm:h-14">
                Hallelujah!
              </span>
              <span className="m-0 block font-extrabold text-5xl text-[#393E46] sm:text-[350%] sm:h-14">
                it's an
              </span>
              <span className="m-0 block text-[#00ADB5] font-extrabold text-5xl sm:text-[350%] sm:h-14">
                Interview
              </span>
              <button
                className="mt-12 bg-[#222831] hover:bg-[#27b118] text-[#EEEEEE] font-bold py-2 px-4 rounded-full sm:mt-6"
          ...
          <div className="h-fit w-[100%] flex justify-center pt-6 items-start sm:w-[60%] sm:items-center sm:h-[100%] sm:pt-0">
            <img className="z-[2] w-[95%]" src={illus} alt="illus" />
          </div>
        </div>
      </div>
    </div>
